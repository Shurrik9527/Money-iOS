...
@implementation Global (CoreDataProperties)

+ (NSFetchRequest<Global *> *)fetchRequest {
	return [NSFetchRequest fetchRequestWithEntityName:@"Global"];
}
...
+(BOOL)AddData:(MarketModel *)model{
    ...
    Global *home=[NSEntityDescription insertNewObjectForEntityForName:@"Global" inManagedObjectContext:kCoreDataContext];
...
// 删除
+(void)DeleteAll{
    NSFetchRequest *request = [NSFetchRequest fetchRequestWithEntityName:@"Global"];
