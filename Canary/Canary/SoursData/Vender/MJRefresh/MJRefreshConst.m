...
const CGFloat MJRefreshHeaderHeight = 55.0;
...
NSString *const MJRefreshHeaderStatePullingText = @"松开后刷新";
NSString *const MJRefreshHeaderStateRefreshingText = @"加载中...";

NSString *const MJRefreshFooterStateIdleText = @"";
NSString *const MJRefreshFooterStateRefreshingText = @"正在加载数据...";
NSString *const MJRefreshFooterStateNoMoreDataText = @"已经加载完毕";
