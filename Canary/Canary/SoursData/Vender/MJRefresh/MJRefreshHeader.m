...
- (UILabel *)stateLabel
{
    if (!_stateLabel) {
        ...
        stateLabel.textColor=LTSubTitleRGB;
...
- (UILabel *)updatedTimeLabel
{
    if (!_updatedTimeLabel) {
        ...
        updatedTimeLabel.textAlignment = NSTextAlignmentLeft;
        updatedTimeLabel.textColor=LTSubTitleRGB;
        updatedTimeLabel.font=[UIFont systemFontOfSize:13];
...
//        // 1.状态标签
//        _stateLabel.frame = CGRectMake(0.36*stateW, 0, 0.64*stateW, stateH);
//        
//        // 2.时间标签
//        CGFloat updatedTimeY = stateH;
//        CGFloat updatedTimeH = self.mj_h - stateH;
//        CGFloat updatedTimeW = stateW;
//        self.updatedTimeLabel.frame = CGRectMake(0.36*stateW, updatedTimeY, 0.64*updatedTimeW, updatedTimeH);

        CGFloat xx = 0.40;
        CGFloat labX = xx*self.mj_w;
        CGFloat labH = 18.f;
        self.stateLabel.frame = CGRectMake(labX, 9.5, (1-xx-0.05)*self.mj_w, labH);
        self.updatedTimeLabel.frame = CGRectMake(labX, self.stateLabel.mj_y+labH, self.stateLabel.mj_w, labH);
    }
}
