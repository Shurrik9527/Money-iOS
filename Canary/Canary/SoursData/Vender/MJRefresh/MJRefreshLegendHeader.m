...
@property(assign,nonatomic)float imageviewAngle;
...
- (void)layoutSubviews
{
    ...
    // 箭头
//    CGFloat arrowX = (self.stateHidden && self.updatedTimeHidden) ? self.mj_w * 0.5 : (self.mj_w * 0.3);
...
//            [self startAnimation:_arrowImage];
            break;
        }
...
- (void)startAnimation:(UIView *)rotationView
{
