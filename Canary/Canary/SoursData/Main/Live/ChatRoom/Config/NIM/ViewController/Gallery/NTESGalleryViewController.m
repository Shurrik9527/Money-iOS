...
@interface NTESGalleryViewController ()<UIGestureRecognizerDelegate>
...
- (instancetype)initWithFrame:(CGRect)frame messageObject:(NSObject *)object;
...
+ (UIView *)alertSingleSnapViewWithMessage:(NSObject *)message baseView:(UIView *)view{
...
//        return nil;
//    }
    SingleSnapView *galleryImageView = [[SingleSnapView alloc] initWithFrame:[UIScreen mainScreen].bounds messageObject:nil];
