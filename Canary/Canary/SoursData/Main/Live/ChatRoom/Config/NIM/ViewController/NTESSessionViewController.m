...
- (void)mediaPicturePressed
{
    ...
    [[AppDelegate sharedInstance].window.rootViewController presentViewController:_imagePicker animated:YES completion:nil];
}
...
//        NSDictionary *dict =[[NSDictionary alloc] initWithObjectsAndKeys:link,@"url",@"八元操盘",@"title", nil];
//        //创建通知
